...
AWS_ACCESS_KEY_ID = os.getenv(key="AWS_ACCESS_KEY_ID_")
AWS_SECRET_ACCESS_KEY = os.getenv(key="AWS_SECRET_ACCESS_KEY_")
...
ALLOWED_HOSTS = ["2jy8dzx2q1.execute-api.us-east-1.amazonaws.com"]
